...
export const TaskBriefingModal: React.FC<TaskBriefingModalProps> = ({ isVisible, taskData, onClose, onStart }) => {
                        ...
                        <View style={styles.rewardsContainer}>
                            {taskData.rewards.map(reward => (
                                <View key={reward.name} style={styles.rewardItem}>
                                    ...
                                    <Text style={styles.rewardText}>{reward.name} x{reward.amount}</Text>
                                </View>
                            ))}
                        </View>
                    </View>
                    <Image source={taskData.characterImage} style={styles.characterImage} />
