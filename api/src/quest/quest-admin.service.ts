...
export class QuestAdminService {
     ...
     */
    async update(id: string, updateDto: UpdateQuestTemplateDto): Promise<QuestTemplateDto> {
        ...
        const updatedTemplate = await this.questTemplateRepository.save(templateToUpdate);
