...
export class WallController {
  ...
  @Get('user/:userId')
  @ApiOkResponse({
    description: '成功獲取用戶留言板列表',
    type: WallMessageListResponse,
  })
  ...
  async update(
    ...
    const updatedMessage = await this.wallService.update(
      updaterId,
      messageId,
      updateDto,
    );
